...
Этот проект предполагает существование собранного проекта `MLIR/LLVM` с наличием  доступа к `MLIRConfig.cmake`. Клонирование и сборка осуществляются следующими командами:
